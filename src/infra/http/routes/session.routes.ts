...
import { addNameUseCase, createSessionUseCase, drawUseCase, dropSessionUseCase, getNamesUseCase } from "../../../container";
...
import { DropSessionController } from "../controllers/drop-session.controller";
...
export async function sessionRoutes(app: FastifyInstance) {
    ...
    const dropSession = new DropSessionController(dropSessionUseCase);
    ...
    app.delete("/sessions/:id", (request: FastifyRequest<{ Params: GetSessionRoute }>, reply: FastifyReply) => dropSession.handle(request, reply));
